...
const App = () => {
  ...
  useEffect(() => {
    async function getCategories() {
      const res = await fetch("http://journal-server-express-production.up.railway.app/categories")
  ...
  useEffect(() => {
    async function fetchEntries() {
      const res = await fetch("http://journal-server-express-production.up.railway.app/entries")
      const data = await res.json()
      setEntries(data)
    }
    fetchEntries()
  ...
  const addEntry = async (category, content) => {
    ...
    const returnedEntry = await fetch("http://journal-server-express-production.up.railway.app/entries", {
      method: "POST",
      headers: {
